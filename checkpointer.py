...
graph_builder.add_conditiona_edges("chatbot", tools_condition)
...
def user_chat():
    ...
    with MongoDBSaver.from_conn_string(DB_URI) as mongo_checkpointer:
        graph_with_cp = create_graph(mongo_checkpointer)
        ...
        while True:
            ...
            for event in graph_with_cp.stream(state, config, stream_node="values"):
                if "message" in event:
